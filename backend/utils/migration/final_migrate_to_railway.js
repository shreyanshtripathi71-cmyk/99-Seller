...
async function migrateDataToRailway() {
    ...
    try {
        ...
        // Clear Railway database with foreign key handling
        ...
        for (const tableName of tableNames) {
            ...
            try {
                ...
                // Remove any AUTO_INCREMENT value from CREATE TABLE statement
                createStatement = createStatement.replace(/AUTO_INCREMENT=\d+\s*/g, '');
                
                // Create table on Railway with foreign key checks disabled
                await railwayConnection.execute('SET FOREIGN_KEY_CHECKS = 0');
